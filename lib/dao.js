...
DataAccessObject.updateAll = function(where, data, options, cb) {
  console.log('updateAll ' + JSON.stringify(where) + ' ' + JSON.stringify(data));
  ...
  Model.notifyObserversOf('access', context, function(err, ctx) {
    ...
    Model.notifyObserversOf('before save', context,
      function(err, ctx) {
        console.log('updateAll after before save');
  ...
  function doUpdate(where, data) {
    console.log('updateAll doUpdate');
    ...
    console.log('updateAll doUpdate 1');
    ...
    Model.notifyObserversOf('persist', context, function(err, ctx) {
      console.log('updateAll doUpdate 2');

      if (err) return cb(err);
      data = ctx.data;
      console.log('updateAll doUpdate 3');
